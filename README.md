# Sound Studio — App Store

A single-page landing site showcasing sound healing and frequency analysis web apps.
...
- Dark theme with subtle waveform animations

## Hosting

Designed for GitHub Pages. Enable Pages in repo settings pointed at the `main` branch root.
